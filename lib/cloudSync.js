 ...
 */
export function listenToCloudUpdates(onUpdateReceived, onLockStatusReceived = null) {
  ...
  // Method 2: Controlled Polling from Vercel API every 4 seconds (gentle on CPU & rate limits)
